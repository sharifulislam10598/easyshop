<?php
  ...
  $search_reasults = new SearchItems();
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="col-md-9 col-sm-7">
            ...
            <div class="row list-view-sorting clearfix">
              ...
              <div class="col-md-10 col-sm-10">
                <div class="pull-right">
                  ...
                  <?php foreach($search_reasults->control_label as $index => $value){?>
                ...
                <div class="pull-right">
                  ...
                  <select class="form-control input-sm">
                  <?php foreach($search_reasults->sort_by as $index => $value){?> 
            ...
            <div class="row product-list">
              <!-- PRODUCT ITEM START -->
              <?php foreach($search_reasults->items as $item){?> 
            ...
            <div class="row">
              ...
              <div class="col-md-8 col-sm-8">
                <ul class="pagination pull-right">
                  ...
                  <?php foreach($search_reasults->paginator as $value){?>
