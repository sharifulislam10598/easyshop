            ...
            <div class="goods-page">
              <div class="goods-data clearfix">
                ...
                <table summary="Shopping cart">
                  ...
                  <?php foreach($wishlist_info->wishlist_info as $info){?> 
                  <tr>
                    <td class="goods-page-image">
                      <a href="<?php echo $info['link'] ?>"><img src="<?php echo $info['img'] ?>" alt="Berry Lace Dress"></a>
                    </td>
                    <td class="goods-page-description">
                      <h3><a href="<?php echo $info['link'] ?>"><?php echo $info['name'] ?></a></h3>
                      <p><strong>Item 1</strong> - Color: <?php echo $info['color'] ?>; Size: <?php echo $info['size'] ?></p>
                      <em><a href="<?php echo $info['link'] ?>">More info is here</a></em>
                    </td>
                    <td class="goods-page-stock">
                    <?php echo $info['stock'] ?>
                    </td>
                    <td class="goods-page-price">
                      <strong><span>$</span><?php echo $info['unit_price'] ?></strong>
                    </td>
