      ...
      <div class="container">
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="col-md-9 col-sm-9">
            ...
            <?php foreach($about->content['first_content'] as $value){?> 
              <p><img src="<?php echo $value['img'] ?>" alt="About us" class="img-responsive"></p> 
            ...
            <?php } ?>
            <?php foreach($about->content['second_content'] as $value){?> 
