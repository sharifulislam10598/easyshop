<?php
  ...
  $term_condition_info = new TermCondition();
      ...
      <div class="container">
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="col-md-9 col-sm-9">
            ...
            <?php foreach($term_condition_info->term_condition_info['first_content'] as $value){?>
            ...
            <?php } ?>
            <?php foreach($term_condition_info->term_condition_info['second_content'] as $value){?> 
