              ...
              <div class="card">
                ...
                <form class="forms-sample" method="post">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="tax" id="exampleInputUsername1" value="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">rate :</label>
                      <input type="text" class="form-control" name="rate" id="exampleInputUsername1" value="">
                    </div>
