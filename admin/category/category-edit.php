          ...
          <div class="row">
            ...
            if((new SiteIdentity())->demo == false){
              if(isset($_POST['update'])){
                $response = (new Categorys())->category_update();
                if(!$response->status){ ?>
              ...
              <?php }else{
                header('location:'.SITE_URL.'/admin/category/categories.php');
              } }}?>
              ...
              <div class="card">
                ...
                <form class="forms-sample" method="post">
                  ...
                  <?php if((new SiteIdentity())-> demo == false){ 
                    $category = (new Categorys())->get_category();
                    ?>
                    
                    <div class="form-group">
                      <label for="exampleInputUsername1">Category Name</label>
                      <input type="text" class="form-control" id="exampleInputUsername1" name="name" value="<?php echo $category['name'] ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">link</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" name="link" value="<?php echo $category['link'] ?>">
