<?php 
    ...
    $currency_id = $_GET['id'];
    $currency_info = (new Currency())->get_currency($currency_id);
    if(isset($_POST['submit'])){
      $response = (new Currency())->currency_update($currency_id);
    }
?>
          ...
          <div class="row">
            ...
            <?php 
              ...
              if(isset($_POST['submit'])){
                $response = (new Currency())->currency_update($currency_id);
                if($response->status){
                  header('location:http://localhost/easyshop/admin/top-header/curency.php');
              } else{?>
              ...
              <div class="card">
                <div class="card-body">
                <form class="forms-sample" method="post" action="http://localhost/easyshop/admin/top-header/curency-edit.php?id=<?php echo $currency_id ?>">
                    <div class="form-group">
                      <label for="exampleInputUsername1">Write a curency name :</label>
                      <input type="text" name="name" class="form-control" id="exampleInputUsername1" value="<?php echo $currency_info['name'] ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Symbol :</label>
                      <input type="text" name="symbol" class="form-control" id="exampleInputUsername1" value="<?php echo $currency_info['symbol'] ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">URL :</label>
                      <input type="text" name="url" class="form-control" id="exampleInputUsername1" value="<?php echo $currency_info['url'] ?>">
                    </div>
