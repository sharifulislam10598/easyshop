                  ...
                  <div class="row">
                    <div class="table-sorter-wrapper col-lg-12 table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                        <?php foreach($nav->nav as $index => $value){?>
                          <tr>
                            <td><?php echo $index + 1 ?></td>
                            <td><?php echo $value['name'] ?></td>
                            <td><?php echo $value['url'] ?></td>
                            <td>
                                <a href="http://localhost/easyshop/admin/top-header/top-header-nav-edit.php?id=<?php echo $value['id'] ?>">
                                    <button class="btn">Edit</button>
                                </a>
                                <a href="http://localhost/easyshop/admin/top-header/top-header-nav.php?id=<?php echo $value["id"]?>">
                    ...
                    <a href="http://localhost/easyshop/admin/top-header/add-top-header-nav.php">
                        <button class="btn">Add a nav</button>
                    </a>
                  </div>
                </div>
              </div>
