              ...
              <div class="card">
                ...
                <form class="forms-sample" method="post">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="name" id="exampleInputUsername1" value="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Symbol :</label>
                      <input type="text" class="form-control" name="symbol" id="exampleInputUsername1" value="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">URL :</label>
                      <input type="text" class="form-control" name="url" id="exampleInputUsername1" value="">
                    </div>
