        ...
        <div class="content-wrapper">
          <div class="page-header">
            ...
            <?php 
                ...
                if(isset($_GET['id'])){
                $response = (new Language())->remove();
                if($response->status){
              ?>

              <div class="alert alert-fill-success" role="alert">
                <i class="fa  fa-check-square"></i>
                <?php echo $response->get_string_messages() ?>
              </div>
              <?php } else{?>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="table-sorter-wrapper col-lg-12 table-responsive">
                      <table class="table">
                        ...
                        <tr>
                            ...
                            <th class="sortStyle">languages</th>
                        ...
                        <?php foreach($languages->language as $index => $value){?>
                          <tr>
                            <td><?php echo $index + 1 ?></td>
                            <td><?php echo $value['name'] ?></td>
                            <td><?php echo $value['url'] ?></td>
                            <td>
                                <a href="http://localhost/easyshop/admin/top-header/language-edit.php?id=<?php echo $value["id"]?>">
                                    <button class="btn">Edit</button>
                                </a>
                                <a href="http://localhost/easyshop/admin/top-header/language.php?id=<?php echo $value["id"]?>">
                    ...
                    <a href="http://localhost/easyshop/admin/top-header/add-language.php">
                        <button class="btn">Add a Language</button>
                    </a>
                  </div>
                </div>
              </div>
