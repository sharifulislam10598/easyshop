        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            ...
            if(isset($_POST['submit'])){
              $response = (new Language())->language_update($language_id);
              if($response->status){
              ...
              $language_info = (new Language())->get_language($language_id);
              ?>
              ...
              <div class="card">
                <div class="card-body">
                <form class="forms-sample" action="http://localhost/easyshop/admin/top-header/language-edit.php?id=<?php echo $language_id ?>" method="post">
                    <div class="form-group">
                      <label for="exampleInputUsername1">Write a language name :</label>
                      <input type="text" name="name" class="form-control" id="exampleInputUsername1" value="<?php echo $language_info['name'] ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">URL :</label>
                      <input type="text" name="url" class="form-control" id="exampleInputUsername1" value="<?php echo $language_info['url'] ?>">
                    </div>
...
<?php
include('C:\xampp\htdocs\easyshop\admin\inc\footer.php');
?>