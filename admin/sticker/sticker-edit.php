        ...
        <div class="row">
            <div class="col-7 grid-margin">
                ...
                if (isset($_POST['update'])) {
                    $response = (new Sticker())->sticker_update($_GET['id']);
                    if ($response->status) {
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" method="post">
                                        ...
                                        <button type="" name="" class="btn btn-primary mr-2">Update</button>
                                        <button onclick="history.back();" class="btn btn-light">Cancel</button>

                                        <?php }else{ 
                                            $sticker_info = (new Sticker())->get_sticker();
                                            ?> 

                                        <div class="form-group">
                                            <label for="exampleInputUsername1">sticker name :</label>
                                            <input type="text" class="form-control" name="sticker" id="exampleInputUsername1" value="<?php echo $sticker_info['sticker'] ?>">
                                        </div>
