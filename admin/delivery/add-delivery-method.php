          ...
          <div class="row">
            ...
            <?php 
              ...
              if(isset($_POST['submit'])){
                $response = (new DeliveryMethodList())->save();
                if($response->status){
              ...
              <div class="card">
                ...
                <form class="forms-sample" method="post">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="method" id="exampleInputUsername1" value="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">shipping cost :</label>
                      <input type="text" class="form-control" name="shipping_cost" id="exampleInputUsername1" value="">
                    </div>
