<?php include('C:\xampp\htdocs\easyshop\admin\inc\header.php');
 $delivery_method_info = (new DeliveryMethodList())->get_delivery_method() ;
          ...
          <div class="row">
            ...
            <?php 
              ...
              if(isset($_POST['update'])){
                $response = (new DeliveryMethodList())->delivery_method_update();
                if($response->status){
                  header('location:'.SITE_URL.'/admin/delivery/delivery-method-list.php');
             } else{?>
              ...
              <div class="card">
                ...
                <form class="forms-sample" method="post">
                    <div class="form-group">
                      <label for="exampleInputUsername1">Write a delivery method :</label>
                      <input type="text" class="form-control" name="method" id="exampleInputUsername1" value="<?php echo $delivery_method_info['method'] ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">shipping cost :</label>
                      <input type="text" class="form-control" name="shipping_cost" id="exampleInputUsername1" value="<?php echo $delivery_method_info['shipping_cost'] ?>">
                    </div>
