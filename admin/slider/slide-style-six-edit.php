          ...
          <div class="row">
            ...
            <?php 
              if(isset($_POST['update'])){
                $response = (new Slider())->slider_update_item_six();
                if(!$response->status){ ?>
              ...
              <div class="card">
                <div class="card-body">
                  <form class="forms-sample" method="post" enctype="multipart/form-data">
                    ...
                    <?php }else{
                        $slide_info = (new Slider())->get_slider_item_six();
                        ?> 
                    ...
                    <div class="form-group row">
                      <label for="exampleInputEmail2" class="col-sm-3 col-form-label">1st line color</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="exampleInputEmail2" name="first_line_color" value="<?php echo $slide_info['first_line_color'] ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputMobile" class="col-sm-3 col-form-label">2nd line</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="exampleInputMobile" name="second_line" value="<?php echo $slide_info['second_line'] ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputMobile" class="col-sm-3 col-form-label">2nd line color</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="exampleInputMobile" name="second_line_color" value="<?php echo $slide_info['second_line_color'] ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputPassword2" class="col-sm-3 col-form-label">third line</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="exampleInputPassword2" name="third_line" value="<?php echo $slide_info['third_line'] ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputPassword2" class="col-sm-3 col-form-label">third line color</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="exampleInputPassword2" name="third_line_color" value="<?php echo $slide_info['third_line_color'] ?>" placeholder="">
                      </div>
                    </div>
