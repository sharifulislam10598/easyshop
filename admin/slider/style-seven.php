        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-12 grid-margin">
              ...
              <div class="card">
                <div class="card-body">
                  <img width="100%" src="<?php echo SITE_URL ?>/admin/images/slider-sample/style-seven.jpg">
                  <h5>Slide style four........</h5>
                <br>
                  <div>
                    <a href="add-style-seven.php">
                        <button class="btn">Add</button>
                    </a>
                    <a href="<?php echo SITE_URL ?>/admin/slider/slider.php">
