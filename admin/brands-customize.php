          ...
          <div class="row">
            ...
            if((new SiteIdentity())->demo == false){
              if(isset($_POST['update'])){
                $response = (new Brand())->brand_update();
                if(!$response->status){ ?>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  if((new SiteIdentity())-> demo == false){
                    $brands = (new Brand())->get_brand();
                  ?>
                  <img width="40px" src="<?php echo SITE_URL.'/'.$brands['brand_img'] ?>">
                  <form class="forms-sample" method="post" enctype="multipart/form-data">
                    <div class="form-group ">
                      <label  class="col-sm-3 col-form-label">Link</label>
                      <div class="col-xs-12">
                        <input type="text" class="form-control" name="link" value="<?php echo $brands['link'] ?>">
                      </div>
                    </div>
                    <div class="form-group">
