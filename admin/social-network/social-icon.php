            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    <div class="table-sorter-wrapper col-lg-12 table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                        <?php 
                        $social_icon = new Footer();
                        foreach($social_icon->social_icon as $value){?>
                          <tr>
                            <td><?php echo $value['icon'] ?></td>
                            <td><?php echo $value['link'] ?></td>
                            <td>
                                <a href="<?php echo SITE_URL?>/admin/social-network/social-icon-edit.php?id=<?php echo $value['id'] ?>">
                                    <button class="btn">Edit</button>
                                </a>
                                <a href="<?php echo SITE_URL ?>/admin/social-network/social-icon.php?id=<?php echo $value['id'] ?>">
                  ...
                  <a href="<?php echo SITE_URL?>/admin/social-network/add-social-icon.php">
